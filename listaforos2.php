...
<div class="panel-heading " style="background-color: #646c7a; color: white;border-color: #DAA520;"><h1 style="text-align:center"><b>Foro</b></div>
  ...
  <div class="panel-heading " style="background-color: #646c7a; color: white;border-color: #DAA520;"><h1 style="text-align:center"><b>Reportes</b></div>
    ...
    <form class="form-horizontal" action="ExportarForos.php" method="post" data-toggle="validator" enctype="multipart/form-data">
        ...
        <input id="fecha2" onchange="ValidarFechaFinal();" name="txtfecha2" type="text" placeholder="Fecha final" class="form-control input-md"  >
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <a class='btn btn-info  '  href='graficoForos.php'>Generar gráfico</a>
            </div>
          </div>
