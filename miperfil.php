...
<body background="img/fondito2.jpg">
...
<div class="panel-heading" style="background-color:black"><h3 style="text-align:center;">Mi Perfil</h3></div>
</div>
    ...
    ?>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input value="<?=$r[5]?>" id="Celular" name="txtcel" type="text"  class="form-control input-md " onkeypress='return validaNumericos(event)' data-minlength="9">
          </div>
        ...
        <div class="form-group">
          <div class="col-md-4"></div>
           <div class="col-md-2">
            ...
            <?php
                if( $tipo == "1"){
                    echo "<a class='btn btn-info col-md-offset-1' href='cambiarcontra.php'>Cambiar Contraseña</a>";}
                else{
                    echo "<a class='btn btn-info col-md-offset-1' href='cambiarcontra.php'>Cambiar Contraseña</a>";
                }
                 ?>
