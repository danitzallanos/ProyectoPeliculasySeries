...
<div class="panel-heading"><h1 style="text-align:center;"><b>Criticas</b></div>
</div>
...
<div class="col-md-6">
   ...
   <h3 style="color:white;">Déjanos tu crítica sobre esta película</h3>
   <?php

   echo"
   <div id='fb-root' ></div>
   <script async defer crossorigin='anonymous' src='https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v3.3'></script>
   <div class='fb-comments' data-mobile='Auto-detected' data-colorscheme='light' data-href='participarcriticapeli.php?peliid=".$foroid."' data-width='600' data-numposts='10'></div>
   <span class='fb-comments-count' data-href='participarcriticapeli.php?peliid=".$foroid."'></span>"


   ?>

       <?php
       $SQL1="SELECT criticas from movies where estado = 1  and movie_id='".$foroid."'" ;
       $fila1 = ejecutar($SQL1);
       $filita1 = mysqli_fetch_array($fila1);
       // echo "Nro de visitas: ".$filita1[0];
       $visitas= 1+$filita1[0];

       $SQL2="UPDATE movies set criticas= '".$visitas."' where estado = 1  and movie_id='".$foroid."'" ;
       // echo $SQL2;
       $fila2 = ejecutar($SQL2);
  ...
  $(document).ready(function() {
     $('.like, .dislike').click(function() {
      ...
      var post_id = $(this).parent().parent().parent().find("#post_id").val();
            ...
            $.ajax({
              url: "../controlador/critica_pelicula_controlador.php",
              method: 'post',
