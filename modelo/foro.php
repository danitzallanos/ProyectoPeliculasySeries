 ...
 $this->userid = $userid;
    ...
    public function eliminar(){
     ...
     public function listaforos(){
        ...
        $query="SELECT f.foro_id,f.title,DATE_FORMAT(f.fecha, '%d-%m-%Y %H:%i'),u.firstname,u.lastname,u.photo,f.respuestas,f.user_id from foro f inner join users u on f.user_id=u.user_id where f.estado = 1 order by f.fecha desc " ;
